            ...
            <bk-row>
                ...
                <bk-col :span="3">
                    <Card
                        ...
                        :show-header="false">
                        <template slot="content">
                            <stats-card style="height: 230px" :card-list="cardList2" :show-vertical="true"
                                        :shape="'hexagon'"></stats-card>
                        </template>
                    </Card>
                </bk-col>
                    ...
                    <Card :show-header="false" style="padding: 16px 0">
                        <template slot="content">
                            ...
                            <display-card
                                ...
                                :show-icon="false"
                                :height="78"
                                style="padding-top: 13px;border-top: 1px solid #DCDEE5">
                            </display-card>
                        </template>
                    </Card>
                </bk-col>
        ...
        data() {
            return {
                ...
                tendData: {
                    ...
                    '15': [
                        {name: '作业一', month: '6th', value: 300},
                        {name: '作业一', month: '9th', value: 1200},
                        {name: '作业一', month: '13th', value: 600},
                        {name: '作业一', month: '14th', value: 500},
                        {name: '作业一', month: '15th', value: 400},
                        {name: '作业二', month: '6th', value: 200},
                        {name: '作业二', month: '9th', value: 1600},
                        {name: '作业二', month: '13th', value: 1100},
                        {name: '作业二', month: '14th', value: 700},
                        {name: '作业二', month: '15th', value: 1000},
                    ],
                    '30': [
                        {name: '作业一', month: '17th', value: 1300},
                        {name: '作业一', month: '20th', value: 200},
                        {name: '作业一', month: '23th', value: 800},
                        {name: '作业一', month: '27th', value: 500},
                        {name: '作业一', month: '29th', value: 1400},
                        {name: '作业二', month: '17th', value: 800},
                        {name: '作业二', month: '20th', value: 600},
                        {name: '作业二', month: '23th', value: 400},
                        {name: '作业二', month: '27th', value: 1300},
                        {name: '作业二', month: '29th', value: 1000},
                    ]
                },
                pieData: {
                    data: [
                        {value: 50, type: '类型1', name: '类型1-1'},
                        {value: 30, type: '类型1', name: '类型1-2'},
                        {value: 10, type: '类型2', name: '类型2-1'},
                        {value: 8, type: '类型2', name: '类型2-2'},
                        {value: 2, type: '类型3', name: '类型3-1'},
                    ],
                    dimension: 'name',
                    metric: 'value',
                    legend: 'type'
                ...
                processData: [
                    {info: '最重要的配置前提提示信息，卡片内只放主要信息。。', color: '#EA3636', background: '#FFDDDD'},
                    {info: '次重要配置前提提示信息，字数控制在1-2行。', color: '#FF9C01', background: '#FFE8C3'},
                    {info: '次要的配置提示信息，或操作指引步骤。。', color: '#3A84FF', background: '#E1ECFF'},
                    {info: '其他信息。点击“查看详情”展开抽屉，显示具体配置或操作信息详情。', color: '#979BA5', background: '#F0F1F5'}
                ],
                jobInfo: [
                    {
                        'num': 2046,
