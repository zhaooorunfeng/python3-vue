        ...
        <bk-container :col="8" :gutter="16" ext-cls="home-container">
                    ...
                    <Card :title="'作业趋势图'">
                        <template slot="header">
                            <div class="bk-button-group">
                                <bk-button :size="'small'" @click="btnGroupSelected = 'year'" :class="btnGroupSelected === 'year' ? 'is-selected' : ''">
                                    近1年
                                </bk-button>
                                <bk-button :size="'small'" @click="btnGroupSelected = 'day'" :class="btnGroupSelected === 'day' ? 'is-selected' : ''">
                                    近30天
                                </bk-button>
                            </div>
                        </template>
            ...
            <bk-row>
                <bk-col :span="4">
                    <Card :title="'作业管理状态'">
                        <template slot="header">
                            <bk-button :text="true" title="primary" ext-cls="font-btn" @click="handleMoreInfo">查看更多
                            </bk-button>
                        </template>
                        <template slot="content">
                    ...
                    <Card :title="'作业数据近5条'">
                        ...
                        <template slot="content">
                            <bk-table :data="tableData">
                                <bk-table-column v-for="field in tableTitle" :key="field.id" :label="field.label" :prop="field.id">
                                </bk-table-column>
                            </bk-table>
                        </template>
                    </Card>
    ...
    export default {
        ...
        data() {
            return {
                ...
                stepList: [{
                               title: '吴昊（总经理）审批通过，并附“同意”',
                               description: '2019-12-12 11:23'
                           },
                           {
                               title: '王坤（组长）审批通过，并附“同意”',
                               description: '2019-12-12 11:23'
                           },
                           {
                               title: '李想（总监）审批通过，并附“同意”',
                               description: '2019-12-12 11:23'
                           },
                           {
                               title: '张晓丽（管理员）审批不通过',
